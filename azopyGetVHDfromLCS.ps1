...
$targetdir = "C:\temp"
$D365VHDname = "D365VHD-10_0_29_part"
...
if ($diskspace -lt 32){
    write-host "Not enough diskspace on $($targetdir.substring(0,2).ToUpper()) for VHD imagefiles. Need approx 29 GB for the VHD files. Extracted VHD image need 133 GB to extract the files." -ForegroundColor red;
    pause;
    exit
}
