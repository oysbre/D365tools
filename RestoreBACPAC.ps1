...
#Run Powershell command below on CHE to download Powershellscript to Desktop. Edit script and fill in SASURL variable with BACPAC link from LCS. Run with Powershell when done.
